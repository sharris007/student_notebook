  ...
  render() {
    return (
      <div>
        ...
        <NoteBookBoard notesList={this.props.notesList} originalNotesList={this.props.originalNotesList} groupExpanded= {this.props.groupExpanded} tocData={this.props.tocData} groupModeFlag={this.props.groupModeFlag} callback={this.props.callback} handleGroupClick={this.props.handleGroupClick} coloums={this.props.coloums}/>
      </div>
    );
  };  
}
